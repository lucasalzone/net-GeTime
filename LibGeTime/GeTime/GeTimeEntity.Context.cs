...
namespace GeTime
{
    ...
    public partial class GeTimeEntities : DbContext
    {
        ...
        public virtual int AddHL(Nullable<System.DateTime> giorno, Nullable<int> nOre, Nullable<int> idU, string nomeCommit)
        {
            var giornoParameter = giorno.HasValue ?
                new ObjectParameter("giorno", giorno) :
                new ObjectParameter("giorno", typeof(System.DateTime));
            ...
            var nomeCommitParameter = nomeCommit != null ?
                new ObjectParameter("nomeCommit", nomeCommit) :
                new ObjectParameter("nomeCommit", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddHL", giornoParameter, nOreParameter, idUParameter, nomeCommitParameter);
        }
